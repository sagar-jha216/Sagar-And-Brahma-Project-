...
class LiquidatorBase(BaseModel):
    ...
    Offer_Price_Pct_of_MRP: float = Field(..., alias="Offer Price (% of MRP)")
    Pickup_SLA_Days: int = Field(..., alias="Pickup SLA (in days)")
    ...
    Past_Fulfillment_Success_Rate_Pct: float = Field(..., alias="Past Fulfillment Success Rate (%)")
...
class LiquidatorUpdate(BaseModel):
    ...
    Offer_Price_Pct_of_MRP: Optional[float] = Field(None, alias="Offer Price (% of MRP)")
    Pickup_SLA_Days: Optional[int] = Field(None, alias="Pickup SLA (in days)")
    ...
    Past_Fulfillment_Success_Rate_Pct: Optional[float] = Field(None, alias="Past Fulfillment Success Rate (%)")
