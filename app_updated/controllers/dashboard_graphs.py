...
def get_dashboard(filters, db: Session):
    ...
    def Sales_Shrinkage_Salvage(df, filters=None):
        ...
        filtered.loc[mask_actual, "Shrinkage%"] = ((filtered.loc[mask_actual, "Difference_System_Actual"] / filtered.loc[mask_actual, "Actual_Quantity_Received"]) * 100).round(1)
        ...
        monthly_data.loc[mask_cogs, "Salvage%"] = ((monthly_data.loc[mask_cogs, "Loss_Mititagion"] / monthly_data.loc[mask_cogs, "COGS"]) * 100).round(1)
