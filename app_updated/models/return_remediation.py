...
class ReturnRemediation(Base):
    ...
    risk_score = Column(Float, name="risk_score")
    ...
    cost_price_cp = Column(Float, name="cost_price_cp")
    selling_price_sp = Column(Float, name="selling_price_sp")
    ...
    # expected_recovery = Column(Float, name="expected_recovery")  # Removed from new database
    # tax_benefit_amount = Column(Float, name="tax_benefit_amount") #Removed from new databse
