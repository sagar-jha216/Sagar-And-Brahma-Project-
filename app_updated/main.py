...
from app.routes.return_remediation_issues import router as return_remediation_issues_router
...
from app.routes import product_master
from app.routes import store_filter
from app.routes.impact_tracker import router as impact_tracker_router
...
app.include_router(remediation_route_router, prefix="/analytics", tags=["Remediation Recommendations API"])
app.include_router(return_remediation_issues_router, prefix="/return-remediation", tags=["Return Remediation Issues"])
...
app.include_router(product_master.router, prefix="/product_master", tags=["product_master"])
app.include_router(store_filter.router, prefix="/store_filter", tags=["store_filter"])
app.include_router(command_center_router, prefix="/analytics", tags=["Command Center"])
app.include_router(impact_tracker_router, prefix="/api/v1", tags=["impact-tracker"])
